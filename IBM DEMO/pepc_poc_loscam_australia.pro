...
%=======================================================================
   ...
   ,supplier_vat_number(`26 006 440 991`)
...
generic_item( [ line_descr, date ] )

,generic_append( [ line_descr, date, q10(tab), ` - ` ,  ` `  ] )

,generic_append( [ line_descr_dummy, s1, q10(tab), ` - ` ,  ` `  ] )
...
, q10(generic_item( [ line_delay_dummy, d, tab ] ))
