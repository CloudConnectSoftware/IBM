...
i_version( d_ibm_unilever_uapl, `24/01/2024 11:05:44` ).
...
header_level_item( `IBM DC XML`, `Total Amount`, `Yes`, `Map total gross amount from document.`, `Map total gross amount from document.`, `Conditional`, `Vendor is not a freight vendor.`, `Rules (Mapped)`, `total_invoice`, `Number`, `1`, `Yes`, `Header Level Items`, `6`, ( not( grammar_set( freight_vendor ) ) ), ( true ) ).
header_level_item( `IBM DC XML`, `Tax Amount`, `Yes`, `Map total tax amount from document.`, `Map total tax amount from document.`, `Always`, ``, `Rules (Mapped)`, `total_vat`, `Number`, `1`, `Yes`, `Header Level Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Currency Code`, `Yes`, `Map currency from invoice, if in words etc must be in converted into ISO standard format. If not present on invoice then default to 'USD', Leocatas hard coded to 'AUD'.`, `Map currency from invoice, if in words etc must be in converted into ISO standard format. If not present on invoice then default to 'USD', Leocatas hard coded to 'AUD'.`, `Always`, ``, `Rules (Mapped)`, `currency`, `String`, `1`, `Yes`, `Header Level Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Due Date`, `Yes`, `Map due date from invoice. Set to default date if not present.`, `Map due date from invoice. Setting to default date if not present automated by p_ file.`, `Never`, ``, `Both Rules & p_`, `due_date`, `Date`, `1`, `Yes`, `Header Level Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Vendor ID`, `Yes`, `Insert vendor's ID, can be found on tab 1 of SDD. Must be padded out to 10 characters with leading zeros.`, `Automated by p_ file, once rules file name updated on connections tab and in d_ file.`, `Always`, ``, `p_ (Hard Coded)`, `buyers_code_for_supplier`, `String`, `1`, `Yes`, `Header Level Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Vendor VAT Code`, `Yes`, `Map vendor's VAT registration number from document.`, `Map vendor's VAT registration number from document.`, `Conditional`, `Mandatory if VAT amount is non-zero.`, `Rules (Mapped)`, `supplier_vat_number`, `String`, `1`, `Yes`, `Header Level Items`, `6`, ( i_error_vat_without_vat_number ), ( true ) ).
...
header_level_item( `IBM DC XML`, `VAT Local Amount`, `Yes`, `Should be mapped if available.`, `Should be mapped if available.`, `Never`, ``, `Rules (Mapped)`, `total_local_vat`, `Number`, `1`, `Yes`, `Header Level Items`, `6`, ( true ), ( true ) ).
...
header_level_item( `IBM DC XML`, `Net Amount`, `Yes`, `Map total net amount from document.`, `Map total net amount from document.`, `Always`, ``, `Rules (Mapped)`, `total_net`, `Number`, `1`, `Yes`, `Header Level Items`, `6`, ( true ), ( true ) ).
...
% Not Inherited
header_level_item( `IBM DC XML`, `Sender Name`, `Yes`, `Insert name of sending organisation.Determines value of Sending Organisation.`, `Hard - code correct value in rules.`, `Always`, ``, `Rules (Hard Coded)`, `sender_name`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Sending Organisation`, `Yes`, `Insert name of sending organisation. Determines sender name in the portal.`, `Automated by u_portal_values. Same value as Sender Name is automatically inserted.`, `Always`, ``, `p_ (Hard Coded)`, `sending_organisation`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Receiving Organisation`, `Yes`, `Insert name of receiving organisation. Determines receiver name in the portal.`, `Automated by u_portal_values. Correct value is automatically inserted.`, `Always`, ``, `p_ (Hard Coded)`, `receiving_organisation`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Customer`, `Yes`, `Insert name of customer. Determines customer name in the portal.`, `Automated by u_portal_values. Correct value is automatically inserted.`, `Always`, ``, `p_ (Hard Coded)`, `customer`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Channel Partner`, `Yes`, `Insert name of channel partner. Determines channel partner name in the portal.`, `Automated by u_portal_values. Correct value is automatically inserted.`, `Always`, ``, `p_ (Hard Coded)`, `channel_partner`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Document Type`, `Yes`, `Insert correct document type. Determines document type in the portal.`, `Automated by p_. Defaults to "Credit Note" if credit_note flag has been set, Order" if purchase_order flag has been set, Invoice" otherwise.`, `Always`, ``, `p_ (Hard Coded)`, `document_type`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
...
header_level_item( `IBM DC XML`, `Intervention RTS Email`, `Yes`, `Insert email address(es) for document to be returned to, based on RTS button selection from intervention.`, `Automated by u_intervention_analysis. Correct value is inserted based on RTS button being pressed by user from intervention.`, `Never`, ``, `Both Rules & p_`, `intervention_rts_email`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Intervention Forward Email`, `Yes`, `Insert email address(es) for document to be forwarded to, based on forward button selection from intervention.`, `Automated by u_intervention_analysis. Correct value is inserted based on forward button being pressed by user from intervention.`, `Never`, ``, `Both Rules & p_`, `intervention_forward_email`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
...
header_level_item( `IBM DC XML`, `Intervention RTS Email Body`, `Yes`, `Insert email body based on RTS button selection from intervention.`, `Automated by u_intervention_analysis. Correct value is inserted based on RTS button being pressed by user from intervention.`, `Never`, ``, `Both Rules & p_`, `intervention_rts_email_body`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Intervention Forward Email Body`, `Yes`, `Insert email body based on forward button selection from intervention.`, `Automated by u_intervention_analysis. Correct value is inserted based on forward button being pressed by user from intervention.`, `Never`, ``, `Both Rules & p_`, `intervention_forward_email_body`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
...
header_level_item( `IBM DC XML`, `Default VAT Rate`, `Yes`, `Map/insert default VAT rate.`, `Map in rules, otherwise automated by Gramatica.`, `Never`, ``, `Rules/Gramatica Derived`, `default_vat_rate`, `Number`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
...
header_level_item( `IBM DC XML`, `Force Result`, `Yes`, `To force portal status, insert 'success', 'failed' or 'defect'.`, `Mapped in rules or automated by junk.pro.`, `Never`, ``, `Both Rules & p_`, `force_result`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
header_level_item( `IBM DC XML`, `Force Sub Result`, `Yes`, `To force portal reason, insert relevant reason.`, `Mapped in rules or automated by junk.pro.`, `Never`, ``, `Both Rules & p_`, `force_sub_result`, `String`, `1`, `Yes`, `Functional Items`, `6`, ( true ), ( true ) ).
...
% Not Inherited
line_level_item( `IBM DC XML`, `Line Invoice Line`, `Yes`, `Insert line number in multiples of 10 (10, 20, 30, …).`, `Automated by p_ file.`, `Always`, ``, `p_ (Hard Coded)`, `line_order_line_number`, `String`, `1`, `No`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Amount`, `Yes`, `Map line gross amount from document.`, `Map line gross amount from document.`, `Always`, ``, `Rules/Gramatica Derived`, `line_total_amount`, `Number`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Tax Percent`, `Yes`, `Map line tax rate from document.`, `Map line tax rate from document.`, `Always`, ``, `Rules/Gramatica Derived`, `line_vat_rate`, `Number`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Tax Amount`, `Yes`, `Map line tax amount from document.`, `Map line tax amount from document.`, `Always`, ``, `Rules/Gramatica Derived`, `line_vat_amount`, `Number`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Tax Code`, `Yes`, `Insert '??'.`, `Automated by p_ file.`, `Always`, ``, `Rules/Gramatica Derived`, `line_vat_code`, `String`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line PO Number`, `Yes`, `Map line purchase order number from invoice. Insert header level purchase order number if not present. Must match purchase order number from PO header file. Truncate to 10 characters, from front (right to left).`, `Map line purchase order number from document. Everything else automated by p_ file.`, `Conditional`, `Vendor is not in the NPNP list.`, `Both Rules & p_`, `line_buyers_order_number`, `String`, `1`, `Yes`, `Line Level Items`, `6`, ( grammar_set(`testing_line_variable`, `line_buyers_order_number`, LID), not( npnp_vendor ) ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Delivery Note`, `Yes`, `Map line delivery note number from document.`, `Map line delivery note number from document.`, `Conditional`, `List to be provided / created as we go through the process. If on invoice map for all vendors and only validate present on those in the list.`, `Rules (Mapped)`, `line_delivery_note_number`, `String`, `1`, `Yes`, `Line Level Items`, `6`, ( grammar_set(`testing_line_variable`, `line_delivery_note_number`, LID), delivery_note_vendor ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Unit Price`, `Yes`, `Map line unit price from document.`, `Map line unit price from document.`, `Always`, ``, `Rules/Gramatica Derived`, `line_unit_amount`, `Number`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Quantity`, `Yes`, `Map line quantity from document.`, `Map line quantity from document.`, `Always`, ``, `Rules/Gramatica Derived`, `line_quantity`, `Number`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
line_level_item( `IBM DC XML`, `Line Material Number`, `Yes`, `Map line item code from document.`, `Map line item code from document.`, `Never`, ``, `Rules (Mapped)`, `line_item`, `String`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
...
line_level_item( `IBM DC XML`, `Line Description`, `Yes`, `Map line description from document.`, `Map line description from document.`, `Never`, ``, `Rules (Mapped)`, `line_descr`, `String`, `1`, `Yes`, `Line Level Items`, `6`, ( true ), ( true ) ).
...
% Not Inherited
header_level_scenario( `1`, `Body of Email`, `No`, `Yes`, `Action From Intervention`, ``, `The document is the body of an email that was sent without any attachments.`, `No`, `No`, `Body of Email`, `No`, `No`, ( i_mail( attachment, `body.html` ) ) ).
...
header_level_scenario( `3`, `Document Size is Too Large`, `Yes`, `No`, `Return to Sender`, ``, `This document file size is too large for CloudTrade to process.`, `No`, `No`, `Document Too Large`, `No`, `No`, ( i_error_too_big ) ).
header_level_scenario( `4`, `Duplicate`, `No`, `Yes`, `Action From Intervention`, ``, `The document has been recognised as a duplicate of one that has previously processed successfully.`, `No`, `No`, `Duplicate`, `No`, `No`, ( grammar_set( i_analyse_duplicate ) ) ).
header_level_scenario( `5`, `Future Date`, `No`, `No`, `Process As Normal`, ``, `The document date is in the future.`, `No`, `No`, `Future Date`, `No`, `No`, ( grammar_set( future_dated, invoice_date  ) ) ).
header_level_scenario( `6`, `Image Document`, `No`, `Yes`, `Action From Intervention`, ``, `The document does not contain any text which can be read by the system, which suggests that it is an image or has been scanned. The ideal format is a data PDF (which is not the same as an image PDF), but any text-based document format will do. If text can be copied and pasted from the document, then it is in a format which is supported by the system.`, `No`, `No`, `Image Document`, `No`, `No`, ( i_error_empty ) ).
header_level_scenario( `7`, `Invalid Invoice Date`, `Yes`, `Yes`, `Return to Sender`, ``, `The value of the Invoice Date was <data>Invoice Date</data>, which is invalid.`, `No`, `No`, `Invalid Invoice Date`, `No`, `No`, ( grammar_set( invoice, `i_analyse_invalid_invoice_date` ) ) ).
header_level_scenario( `8`, `Invalid Invoice Number`, `Yes`, `Yes`, `Return to Sender`, ``, `The value of the Invoice Date was <data>Invoice Number</data>, which is invalid.`, `No`, `No`, `Invalid Invoice Number`, `No`, `No`, ( grammar_set( invoice, `i_analyse_invalid_invoice_number` ) ) ).
header_level_scenario( `9`, `Invoice quotes tax but is not a tax invoice`, `Yes`, `No`, `Return to Sender`, ``, `Invoice does not state that it is a "Tax Invoice", despite charging tax.`, `No`, `No`, `Tax Quoted On Invoice`, `Yes`, `Yes`, ( result( _, invoice, total_vat, VAT ), not( q_sys_comp_str_eq( VAT, `0` ) ), not( grammar_set( tax_invoice ) ) ) ).
header_level_scenario( `10`, `Invoice With Negative Totals`, `Yes`, `No`, `Return to Sender`, ``, `The document contains negative totals but does not appear to be a credit note.`, `No`, `No`, `Invoice With Negative Totals`, `No`, `No`, ( i_error_negative_totals ) ).
header_level_scenario( `11`, `Missing Currency Code`, `Yes`, `Yes`, `Action From Intervention`, ``, `The document is missing the following piece of data: Currency Code`, `No`, `No`, `Missing Currency Code`, `No`, `No`, ( not( result( _, invoice, currency, _ ) ) ) ).
header_level_scenario( `12`, `Missing Document Date`, `Yes`, `Yes`, `Return to Sender`, ``, `The document is missing the following piece of data: Document Date`, `No`, `No`, `Missing Document Date`, `No`, `No`, ( not( result( _, invoice, invoice_date, _ ) ) ) ).
header_level_scenario( `13`, `Missing Invoice Number`, `Yes`, `Yes`, `Return to Sender`, ``, `The document is missing the following piece of data: Invoice Number`, `No`, `No`, `Missing Invoice Number`, `No`, `No`, ( not( result( _, invoice, invoice_number, _ ) ) ) ).
header_level_scenario( `14`, `Missing Invoice Type`, `Yes`, `Yes`, `Action From Intervention`, ``, `The document is missing the following piece of data: Invoice Type`, `No`, `No`, `Missing Invoice Type`, `No`, `No`, ( not( result( _, invoice, invoice_type, _ ) ) ) ).
header_level_scenario( `15`, `Missing Net Amount`, `Yes`, `Yes`, `Return to Sender`, ``, `The document is missing the following piece of data: Net Amount`, `No`, `No`, `Missing Net Amount`, `No`, `No`, ( not( result( _, invoice, total_net, _ ) ) ) ).
header_level_scenario( `16`, `Missing Scan ID`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Scan ID`, `No`, `No`, `Missing Scan ID`, `No`, `No`, ( not( result( _, invoice, scan_id, _ ) ) ) ).
header_level_scenario( `17`, `Missing Tax Amount`, `Yes`, `Yes`, `Return to Sender`, ``, `The document is missing the following piece of data: Tax Amount`, `No`, `No`, `Missing Tax Amount`, `No`, `No`, ( not( result( _, invoice, total_vat, _ ) ) ) ).
header_level_scenario( `18`, `Missing Total Amount`, `Yes`, `Yes`, `Return to Sender`, ``, `The document is missing the following piece of data: Total Amount`, `No`, `No`, `Missing Total Amount`, `No`, `No`, ( not( result( _, invoice, total_invoice, _ ) ), not( grammar_set( freight_vendor ) ) ) ).
header_level_scenario( `19`, `Missing Vendor ID`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Vendor ID`, `No`, `No`, `Missing Vendor ID`, `No`, `No`, ( not( result( _, invoice, buyers_code_for_supplier, _ ) ) ) ).
header_level_scenario( `20`, `New Layout`, `No`, `Yes`, `Action From Intervention`, ``, `The document has a new layout to any which have previously been sent by the organisation that the document relates to. A new mapping will need to be completed if the document is to be processed.`, `No`, `No`, `New Layout`, `No`, `No`, ( grammar_set( i_analyse_new_layout ) ) ).
header_level_scenario( `21`, `No Lines`, `Yes`, `No`, `Return to Sender`, ``, `The document does not contain any lines.`, `No`, `No`, `No Lines`, `No`, `No`, ( i_error_missing_lines ) ).
header_level_scenario( `22`, `Not On Project`, `No`, `Yes`, `Action From Intervention`, ``, `The organisation that the document relates to has not been added to the system by the customer. This means that the document cannot be processed.`, `No`, `No`, `Not On Project`, `No`, `No`, ( grammar_set( i_analyse_not_on_project ) ) ).
header_level_scenario( `23`, `Old Date`, `No`, `No`, `Process As Normal`, ``, `The document date is older than the allowance.`, `No`, `No`, `Old Date`, `No`, `No`, ( grammar_set( over_x_days_old, invoice_date  ) ) ).
header_level_scenario( `24`, `PDF Error`, `No`, `Yes`, `Action From Intervention`, ``, `The document is a PDF which is either secured or contains an embedded font, which means that the system cannot read the text contained within the document. In order for the document to be processed, it must be generated by either using a different method or by changing the settings on the application which generates the document. The ideal format is a data PDF (which is not the same as an image PDF), but any text-based document format will do. If text can be copied and pasted from the document, then it is in a format which is supported by the system.`, `No`, `No`, `PDF Error`, `No`, `No`, ( i_error_pdf_error ) ).
header_level_scenario( `25`, `Positive & Negative Lines`, `No`, `No`, `Process As Normal`, ``, `The document contains both credit and debit lines.`, `No`, `No`, `Positive and Negative Lines`, `No`, `No`, ( i_error_positive_and_negative_lines ) ).
header_level_scenario( `27`, `Statement/Correspondence`, `No`, `Yes`, `Action From Intervention`, ``, `The document is a statement or some other document which requires manual processing.`, `No`, `No`, `Statement/Correspondence`, `No`, `No`, ( grammar_set( i_analyse_statement_correspondence ) ) ).
header_level_scenario( `28`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `Yes`, `No`, `Return to Sender`, ``, `The sum of the line gross amounts are not equal to the total gross amount. Sum of Line Gross Amounts = <data>Sum of Line Gross Amounts</data>, Total Gross Amount = <data>Total Gross Amount</data>, Difference = <data>Gross Difference</data>.`, `No`, `No`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `No`, `No`, ( i_error_sum_total_integer_discrepancy ) ).
header_level_scenario( `29`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `Yes`, `No`, `Return to Sender`, ``, `The sum of the line net amounts are not equal to the total net amount. Sum of Line Net Amounts = <data>Sum of Line Net Amounts</data>, Total Net Amount = <data>Total Net Amount</data>, Difference = <data>Net Difference</data>.`, `No`, `No`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `No`, `No`, ( i_error_sum_net_integer_discrepancy ) ).
header_level_scenario( `30`, `Supporting Document`, `No`, `No`, `Merge With Image of Processed Document`, ``, `The document has been detected to be a supporting document for another that has successfully processed.`, `No`, `No`, `Supporting Document`, `No`, `No`, ( grammar_set( i_analyse_supporting_document) ) ).
header_level_scenario( `31`, `Totals Do Not Add Up`, `Yes`, `No`, `Return to Sender`, ``, `The document contains inconsistent totals, i.e. Total Net + Total VAT \= Total Gross.`, `No`, `No`, `Totals Do Not Add Up`, `No`, `No`, ( i_error_invoice_integer_totals_inconsistent ) ).
header_level_scenario( `32`, `Unrecognised/Failed to Map Any Data`, `No`, `Yes`, `Action From Intervention`, ``, `The document is either unrecognised or has failed to map any data. This is usually because it is a document that does not require processing, such as a statement or a body of an email, but can also be because the layout of the document is different to previous documents from the sender.`, `No`, `No`, `Unrecognised`, `No`, `No`, ( missed_data_items_condition ) ).
header_level_scenario( `33`, `Unsupported File Extension`, `No`, `Yes`, `Action From Intervention`, ``, `The document has a file extension which is unsupported by the system. The ideal format is a data PDF (which is not the same as an image PDF), but any text-based document format will do. If text can be copied and pasted from the document, then it is in a format which is supported by the system.`, `No`, `No`, `Unsupported File Type`, `No`, `No`, ( i_error_unsupported_file_type ) ).
header_level_scenario( `34`, `Zero Value Document`, `No`, `No`, `Return to Sender`, ``, `The document has a total value of zero.`, `No`, `No`, `Zero Value Document`, `No`, `No`, ( i_error_zero_value_invoice ) ).
...
% Not Inherited
line_level_scenario( `26`, `Quantity Times Unit Amount Not Equal to Net Amount`, `Yes`, `No`, `Return to Sender`, ``, `The quantity times the unit price is not equal to the net price for lines <data>Quantity Times Unit Amount Not Equal to Net Amount Occurred At Lines</data>.`, `No`, `No`, `Quantity Times Unit Amount Not Equal to Net Amount`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `26_Quantity Times Unit Amount Not Equal to Net Amount`, LID), i_error_quantity_and_unit_and_net_amounts_inconsistent( LID, `0.03` ) ) ).
line_level_scenario( `35`, `Zero Value Line`, `No`, `No`, `Suppress Output of Zero Value Lines`, ``, `The following lines are zero value: <data>Zero Value Line At Lines</data>.`, `No`, `No`, `Zero Value Line`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `35_Zero Value Line`, LID), i_error_zero_value_line( LID ) ) ).
...
connection_lookup_table( `ul_uapl_maersk_as_dba`, [ ( return_email, `Omar.Montes@sealandmaersk.com`), ( buyers_code_for_supplier, `51467517` ) ], ( true ) ).
...
connection_lookup_table( `ul_uapl_meiyume_manufacturing`, [ ( return_email, `sujareeSakhon@Meiyume.com`), ( buyers_code_for_supplier, `50539320` ) ], ( true ) ).