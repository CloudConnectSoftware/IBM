...
header_level_scenario( `32`, `Invoice quotes tax but is not a tax invoice`, `Yes`, `No`, `Return to Sender`, ``, `Invoice does not state that it is a "Tax Invoice", despite charging tax.`, `No`, `No`, `Tax Quoted On Invoice`, `No`, `Yes`, ( result( _, invoice, total_vat, VAT ), not( q_sys_comp_str_eq( VAT, `0` ) ), not( grammar_set( tax_invoice ) ) ) ).
