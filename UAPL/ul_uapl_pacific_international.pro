...
[ check( Currency = `SGD` ) , generic_horizontal_details( [ [ `A`, `/`, `C` ],  supplier_bank_account_number, w, [`-`,`SGD`] ] ) ]


, [ check( Currency = `USD` ), generic_horizontal_details( [ [`A`, `/`, `C`, `NO`, `:`],  supplier_bank_account_number, w, [`-`, `USD`]] ) ] 
