...
:-
    ...
    sys_findall( TOT,   
        result( _, _, line_total_amount, TOT ),   
        TOTs  ),  
     
    i_user_check( sum_string_list, TOTs, Sum1 ),  
    
    assertz_derived_data( invoice, total_invoice, Sum1, i_sum_all_line_totals),  
    !
    .
