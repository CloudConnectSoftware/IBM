...
%=======================================================================
    ...
    ,generic_item( [ line_net_amount, [ begin , q( [dec,  other_skip(",")], 1,10),q(other(".") , 1 , 1 ) , q( [ dec  ] , 1 , 2 ), end ] ] )
...
%=======================================================================
    ...
    , generic_item( [ line_net_amount, [ begin , q( [dec,  other_skip(",")], 1,10),q(other(".") , 1 , 1 ) 
                                                ,  q( dec , 1 , 2 ), end ]  ] )
