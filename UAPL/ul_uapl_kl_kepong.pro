...
i_version( ul_uapl_kl_kepong, `2024-09-13 08:56:48` ).
...
%=======================================================================
   ...
   , or([
     ...
     , generic_vertical_details( [ [ `Subtotal`,  newline ], `Subtotal`, q(0,1), (start,100,500), total_net, d, newline ] )
...
%=======================================================================
  ...
  , or([
       ...
       , generic_vertical_details( [ [`0`, `%`, `Sales`, `Tax` ], `Sales`, q(0,1), (start,100,500), total_vat, d, newline ] )
...
%=======================================================================
   ...
   % , check_text(`Total`)
    ...
    , or([
        ...
        generic_horizontal_details( [ [ `Subtotal`, tab ],  line_net_amount, d, newline ] )
...
%=======================================================================
    ...
    , or([
        ...
        generic_horizontal_details( [ [ `Sales`, `Tax`, tab ],  line_vat_amount, d, newline ] )
    ])
...
% Updated by   - Rohini
% Changes made - Total net, Total Vat and Invoice total


% Updated on   - 2 5 Oct, 2021
% Updated by   - ROhini
% Changes made - get_line_vat_amount mapped, line amount updated
