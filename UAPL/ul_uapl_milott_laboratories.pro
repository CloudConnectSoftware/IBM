...
%=======================================================================
    ...
    , generic_vertical_details( [ [ `Kuala`, `Lumpur`, `,`, `Malaysia`,  newline ], `Kuala`, q(0,3,up), (start,100,300), invoice_number , d , tab ] ) 
...
%=======================================================================
    ...
    , generic_vertical_details( [ [ `Kuala`, `Lumpur`, `,`, `Malaysia`,  newline ], `Kuala`, q(0,3,up), (start,100,300), invoice_date , date , newline ] ) 
...
% Updated by   - Roopesh
% Changes made - Invoice number and date updated with new format
