...
i_version( ul_uapl_maersk_as_dba, `24 Sep, 2024` ).
...
%=======================================================================
i_rule( get_net_invoice_1, [
%=======================================================================

     q0n(line)

   , generic_horizontal_details( [ [ `Total`,  `Net`,  `Amount`,  tab, `USD`,  tab ],total_net, d, newline ] )
  
   , check( total_net = TotNet2)

   , generic_item( [ line_net_amount , TotNet2 ] )
