...
%=======================================================================
   ...
   [check( Currency = `SGD` ) ,  generic_horizontal_details( [ [  `Account`, `No`, `.`, `:` ],  supplier_bank_account_number_raw, w, [`(`, `SGD`, `A`, `/`, `C`, `)`,  newline ] ] ) ]
  ,[ check( Currency = `USD` ) ,  generic_horizontal_details( [ [  `Account`, `No`, `.`, `:` ],  supplier_bank_account_number_raw, w, [`(`, `USD`, `A`, `/`, `C`, `)`,  newline ] ] ) ]
  ,[ check( Currency = `EUR` ) ,  generic_horizontal_details( [ [  `Account`, `No`, `.`, `:` ],  supplier_bank_account_number_raw, w, [`(`, `EUR`, `A`, `/`, `C`, `)`,  newline ] ] ) ]
