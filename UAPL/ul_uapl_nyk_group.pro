...
[ check( Currency = `SGD` ) , generic_horizontal_details( [ [  `SGD`, `#`],  supplier_bank_account_number, w, newline ] ) ]


, [ check( Currency = `USD` ), generic_horizontal_details( [ [  `USD`, `#`],  supplier_bank_account_number, w, newline ] ) ] 
