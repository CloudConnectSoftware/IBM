%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LINDE -  KAPITAAL GAS B.V.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

i_version(linde_bn_kapitaal_gas, `15 June, 2018` ).
...
%=======================================================================
    ...
    sender_name( `KAPITAAL GAS B.V.` )

    ,supplier_party( `KAPITAAL GAS B.V.` )

    , supplier_vat_number(`820025574B01`)
...
%=======================================================================
    ...
    , [generic_horizontal_details( [ [`IBAN`, `:` ],  supplier_iban_raw,s1,tab ] )
...
%=======================================================================
   ...
   , generic_horizontal_details( [ [ `Middelharnis`], invoice_date, date, [`.`,  newline] ] )
...
%=======================================================================
   ...
   , generic_horizontal_details( [ [ `Totaal`, `exclusief`, `BTW`, tab], total_netRaw, d, newline ] )
...
%=======================================================================
   ...
   , set(reverse_punctuation_in_numbers) ,set(regexp_cross_word_boundaries)
    ...
    , generic_horizontal_details( [ [ `BTW`, generic_item( [ default_vat_rate, d ] ), `%`,`excl`, `.`, tab], total_vat, d, newline ] )
...
%=======================================================================
   ...
   , set(reverse_punctuation_in_numbers) ,set(regexp_cross_word_boundaries)
    ...
    , generic_horizontal_details( [ [  `Totaal`, `binnen`, generic_item( [ payment_terms, d ] ), `dagen`, `te`, `betalen`, `;`, tab], total_invoice, d, newline ] )
...
[ `Aantal`, tab, `omschrijving`, tab, `Prijs`, tab]
