%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LINDE - EUC POLG. DE ACTIVIDADES COMPLEMENTARIAS `°`
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

i_version(linde_es_euc_polg, `04 July, 2018` ).
...
%=======================================================================
    ...
    sender_name( `EUC POLG. DE ACTIVIDADES COMPLEMENTARIAS` )

    ,supplier_party( `EUC POLG. DE ACTIVIDADES COMPLEMENTARIAS` )

    ,supplier_vat_number(`V11828258`)
...
%=======================================================================
   ...
   , generic_vertical_details( [ [`CONCEPTO`, tab ], `CONCEPTO`, q(0,1,up), (start, 500, 400), invoice_number, d, [ tab, generic_item( [ invoice_date, date ] ), tab] ] )
...
%=======================================================================
    ...
    , generic_vertical_details( [ [ `BASE`, `IMPONIBLE`, tab ], `BASE`, q(0,1), (start, 80, 30), total_net, d, tab ] )
...
%=======================================================================
    ...
    , generic_vertical_details( [ [ `IMPORTE`, `IVA`, tab ], `IMPORTE`, q(0,1), (end, 30, 40), total_vat, d, tab ] )
...
%=======================================================================
    ...
    , generic_vertical_details( [ [`TOTAL`, `EUROS`,  newline], `TOTAL`, q(0,1), (start, 30, 40), total_invoice, d, newline ] )
...
%=======================================================================
    ...
    , generic_vertical_details( [ [ `%`, `IVA`, tab], `IVA`, q(0,1), (start, 30, 40), default_vat_rate, d, tab ] )
...
%=======================================================================
 ...
 or([
   ...
   [`BASE`, `IMPONIBLE`, tab, `%`, `IVA`, tab, `IMPORTE`, `IVA`, tab, `%`, `IRPF`, tab]
