...
%=======================================================================
    ...
    q(0,80,line)
     ...
     , [generic_horizontal_details( [ [`Bank`, `:`, `ABN`, `-`, `AMRO`, generic_item( [ supplier_iban_raw, s ] ), `,`, `SWIFT`, `:`],  supplier_swift_code,s1, newline ] )
...
%=======================================================================
    ...
    , qn0( [ peek_fails(line_end_line)
        ...
        , line_invoice_line_1, line_invoice_line_append]
