%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LINDE - Primagaz Nederland B.V.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

i_version(linde_bn_primagaz_nl, `15 June, 2018` ).
...
%=======================================================================
    ...
    sender_name( `Primagaz Nederland B.V.` )

    ,supplier_party( `Primagaz Nederland B.V.` )

    , supplier_vat_number(`NL001051726B01`)
...
%=======================================================================
    ...
    , generic_horizontal_details( [ [`Factuurnr`, `.`, tab ], invoice_number, s1, tab ] )
...
%=======================================================================
   ...
   ,generic_horizontal_details( [ [`Vervaldatum`, tab], due_date, date, tab ] ) 
...
%=======================================================================
    ...
    , generic_horizontal_details( [ [`Uw`, `referentie`, tab ], order_number, s1, tab ] )
...
%=======================================================================
   ...
   , set(reverse_punctuation_in_numbers) ,set(regexp_cross_word_boundaries)
    ...
    , generic_horizontal_details( [ [`Totaal`, `EUR`, `excl`, `.`, `btw`, tab], total_net, d, newline ] )
...
%=======================================================================
   ...
   , set(reverse_punctuation_in_numbers) ,set(regexp_cross_word_boundaries)
    ...
    , generic_horizontal_details( [ [ generic_item( [ default_vat_rate, d ] ), `%`, `btw`, tab], total_vat, d, newline ] )
...
%=======================================================================
   ...
   , set(reverse_punctuation_in_numbers) ,set(regexp_cross_word_boundaries)
    ...
    , generic_horizontal_details( [ [ `Totaal`, `door`, `u`, `te`, `betalen`, `EUR`, `incl`, `.`, `btw`, tab ], total_invoice, d, newline ] )
...
[`Omschrijving`, tab, `Datum`, tab, `Aantal`, `Eenh`, `.`, tab, `Prijs`]
...
%=======================================================================
    ...
    , generic_item( [ line_dummy_1, date, tab ] )  
    ...
    , generic_item( [ line_unit_uom, w, tab ] ) 
