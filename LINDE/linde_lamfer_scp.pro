...
%=======================================================================
    ...
    sender_name( `LAMFER SCP` )

    ,supplier_party( `LAMFER SCP            ` )

    , supplier_vat_number(`J 64.525.595`)
...
%=======================================================================
    ...
    , or([
     ...
     generic_vertical_details( [ [ `Factura`, tab, `Fecha`], `Factura` , q(0,1), (start,15,25), invoice_number_raw,d , tab ] )
...
%=======================================================================
   ...
   , or([
    ...
    generic_vertical_details( [ [ `Fecha`], `Fecha` , q(0,1), (end,25,25), invoice_date,date , tab ] )
...
%=======================================================================
   ...
   , or([
      ...
      generic_vertical_details( [ [ `PEDIDO` ], `PEDIDO`, q(0,1), (end,20,20), order_number, d, newline ] )
...
%=======================================================================
   ...
   , or([
       ...
       generic_vertical_details( [ [ `Vencimiento` ], `Vencimiento`, q(0,1), (end,20,20), payment_terms, d, `dias` ] )
