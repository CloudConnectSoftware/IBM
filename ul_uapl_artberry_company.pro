...
%=======================================================================
    ...
    , generic_vertical_details( [ [ `TOTAL`, `AMOUNT`, newline ], `AMOUNT`, q(0,3,up), (end,95,95), total_invoice, d, tab ] )
...
q0n(line)
    ...
    , generic_horizontal_details( [ [ `GRAPHIC`, `DESIGN` ], 750, currency , w, tab ] )
