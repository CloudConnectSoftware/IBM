%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AMKOR TECHNOLOGY PHILIPPINES INC P3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

i_version(micron_amkor_phillippines, `20 March 2018` ).
...
%=======================================================================
    ...
    sender_name( `AMKOR TECHNOLOGY PHILIPPINES INC P3` )

   ,bill_from(`AMKOR TECHNOLOGY PHILIPPINES INC P3`)
   ...
   , swiss_supplier_name(`AMKOR TECHNOLOGY PHILIPPINES INC P3`)
