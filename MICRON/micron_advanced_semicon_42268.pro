...
%=======================================================================
    ...
    ,  generic_horizontal_details( [ [`INVOICE`, q10(`No`), `:` , tab  ], invoice_number, s1, newline ] )
...
%=======================================================================
    ...
    ,or([
     ...
     generic_item( [line_descr , s , [q10(tab), check(line_descr(end) < -141)] ] )
