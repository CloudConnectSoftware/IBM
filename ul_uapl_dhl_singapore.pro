...
i_version( ul_uapl_dhl_singapore, `14/10/2016` ).
...
%=======================================================================
    ...
    ,  generic_horizontal_details( [ [ `INVOICE` ],30, invoice_number, s1, newline ] )
...
%=======================================================================
    ...
    , generic_horizontal_details( [ [ `Date`  ],100, invoice_date, s1, newline ] )
...
%=======================================================================
 ...
 , generic_horizontal_details( [ [ `Due` , `Date` ],100, due_date, s1, newline ] )
