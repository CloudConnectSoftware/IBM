...
i_op_param( xml_transform( supplier_bank_iban, In ), _, _, _, Out ) :- size_restrict_text( In, 34, Out ).
...
i_op_param( xml_transform( supplier_bank_iban_2, In ), _, _, _, Out ) :- size_restrict_text( In, 34, Out ).
...
i_op_param( xml_transform( supplier_bank_iban_3, In ), _, _, _, Out ) :- size_restrict_text( In, 34, Out ).
...
i_op_param( xml_transform( supplier_bank_iban_4, In ), _, _, _, Out ) :- size_restrict_text( In, 34, Out ).
...
i_op_param( xml_transform( supplier_bank_iban_5, In ), _, _, _, Out ) :- size_restrict_text( In, 34, Out ).
...
i_op_param( xml_transform( supplier_bank_iban_6, In ), _, _, _, Out ) :- size_restrict_text( In, 34, Out ).
