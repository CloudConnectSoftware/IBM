...
i_version( d_taulia_ibm_amat, `13/06/2025 07:34:45` ).
...
header_level_scenario( `37`, `No Lines`, `Yes`, `No`, `Return to Sender`, ``, `The document does not contain any lines.`, `No`, `No`, `No Lines`, `No`, `No`, ( i_error_missing_lines ) ).
...
header_level_scenario( `41`, `Positive & Negative Lines`, `Yes`, `No`, `Return to Sender`, ``, `The document contains both positive and negative lines.`, `No`, `No`, `Positive and Negative Lines`, `No`, `No`, ( i_error_positive_and_negative_lines ) ).
...
header_level_scenario( `45`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `Yes`, `No`, `Return to Sender`, ``, `The sum of the line gross amounts are not equal to the total gross amount. Sum of Line Gross Amounts = <data>Sum of Line Gross Amounts</data>, Total Gross Amount = <data>Total Gross Amount</data>, Difference = <data>Gross Difference</data>.`, `Yes`, `No`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `Yes`, `Yes`, ( i_error_sum_total_discrepancy( `0.05` ), not(chained_to( `generic_taulia` )), not(chained_to( `nexans hydro` )), not( grammar_set( no_total_validation ) ) ) ).
header_level_scenario( `47`, `Totals Do Not Add Up`, `Yes`, `No`, `Return to Sender`, ``, `The document contains inconsistent totals, i.e. Total Net + Total VAT \= Total Gross.`, `Yes`, `No`, `Totals Do Not Add Up`, `Yes`, `Yes`, ( i_error_invoice_totals_inconsistent( `0.01` ) ) ).
...
header_level_scenario( `46`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `Yes`, `No`, `Return to Sender`, ``, `The sum of the line net amounts are not equal to the total net amount. Sum of Line Net Amounts = <data>Sum of Line Net Amounts</data>, Total Net Amount = <data>Total Net Amount</data>, Difference = <data>Net Difference</data>.`, `Yes`, `No`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `Yes`, `Yes`, ( i_error_sum_net_discrepancy( `0.05` ), not(chained_to( `generic_taulia` )), not(chained_to( `nexans hydro` )), not( grammar_set( no_total_validation ) ) ) ).
