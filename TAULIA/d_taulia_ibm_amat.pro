...
i_version( d_taulia_ibm_amat, `08/04/2024 13:21:51` ).
...
header_level_scenario( `37`, `No Lines`, `No`, `No`, `Process As Normal`, ``, `The document does not contain any lines.`, `No`, `No`, `No Lines`, `No`, `No`, ( i_error_missing_lines ) ).
...
header_level_scenario( `45`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `No`, `No`, `Process As Normal`, ``, `The sum of the line gross amounts are not equal to the total gross amount. Sum of Line Gross Amounts = <data>Sum of Line Gross Amounts</data>, Total Gross Amount = <data>Total Gross Amount</data>, Difference = <data>Gross Difference</data>.`, `Yes`, `No`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `Yes`, `Yes`, ( i_error_sum_total_discrepancy( `0.05` ), not(chained_to( `generic_taulia` )), not(chained_to( `nexans hydro` )), not( grammar_set( no_total_validation ) ) ) ).
header_level_scenario( `46`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `No`, `No`, `Process As Normal`, ``, `The sum of the line net amounts are not equal to the total net amount. Sum of Line Net Amounts = <data>Sum of Line Net Amounts</data>, Total Net Amount = <data>Total Net Amount</data>, Difference = <data>Net Difference</data>.`, `Yes`, `No`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `Yes`, `Yes`, ( i_error_sum_net_discrepancy( `0.05` ), not(chained_to( `generic_taulia` )), not(chained_to( `nexans hydro` )), not( grammar_set( no_total_validation ) ) ) ).
