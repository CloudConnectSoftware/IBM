...
i_version( d_taulia_ibm_amat, `23/07/2026 11:12:38` ).
...
header_level_item( `Taulia JSON`, `Customer Reference Number`, `Yes`, `Map as required.`, `Map as required.`, `Conditional`, ``, `Rules (Mapped)`, `suppliers_code_for_buyer`, `String`, `1`, `Yes`, `Header Level Details`, `6`, ( grammar_set( non_po ) ), ( true ) ).
...
header_level_item( `Taulia JSON`, `Purchase Order Reference Number`, `Yes`, `Map purchase order number.`, `Map purchase order number.`, `Conditional`, ``, `Rules (Mapped)`, `order_number`, `String`, `1`, `Yes`, `Header Level Details`, `6`, ( not( grammar_set( non_po ) ) ), ( true ) ).
...
header_level_item( `Taulia JSON`, `Vendor Reference Number`, `Yes`, `Map as required.`, `Map as required.`, `Conditional`, ``, `Rules (Mapped)`, `buyers_code_for_supplier`, `String`, `1`, `Yes`, `Header Level Details`, `6`, ( grammar_set( non_po ) ), ( true ) ).
...
line_level_item( `Taulia JSON`, `Line VAT Code`, `Yes`, `Insert VAT code for the data item.`, `Automated by p_, otherwise inserted by Gramatica.`, `Never`, ``, `p_ (Hard Coded)`, `line_vat_code`, `String`, `1`, `No`, `Line Level Details`, `6`, ( true ), ( true ) ).
...
header_level_scenario( `4`, `File Size Over 15MB`, `Yes`, `No`, `Return to Sender`, ``, `The file size for the document is over 15MB.`, `No`, `No`, `File Size Over 15MB`, `Yes`, `Yes`, ( i_mail( size, Size ), Size > 15000000 ) ).
...
header_level_scenario( `7`, `Invalid Invoice Date`, `Yes`, `No`, `Return to Sender`, ``, `The value for the Invoice Date was '<data>Invoice Date</data>', which is invalid.`, `No`, `No`, `Invalid Invoice Date`, `No`, `No`, ( grammar_set( invoice, `i_analyse_invalid_invoice_date` ) ) ).
header_level_scenario( `8`, `Invalid Invoice Number`, `Yes`, `No`, `Return to Sender`, ``, `The value for the Invoice Number was '<data>Invoice Number</data>', which is invalid.`, `No`, `No`, `Invalid Invoice Number`, `No`, `No`, ( grammar_set( invoice, `i_analyse_invalid_invoice_number` ) ) ).
header_level_scenario( `12`, `Missing Currency`, `Yes`, `No`, `Return to Sender`, ``, `The document is missing the following piece of data: Currency`, `No`, `No`, `Missing Currency`, `Yes`, `Yes`, ( not( result( _, invoice, currency, _ ) ) ) ).
header_level_scenario( `21`, `Missing Invoice Date`, `Yes`, `No`, `Return to Sender`, ``, `Please note that the invoice date is missing. Please resubmit with a provided invoice date.`, `Yes`, `No`, `Missing Invoice Date`, `Yes`, `Yes`, ( not( result( _, invoice, invoice_date, _ ) ) ) ).
header_level_scenario( `22`, `Missing Invoice Number`, `Yes`, `No`, `Return to Sender`, ``, `Please note that the invoice number is missing. Please resubmit with a provided invoice number.`, `Yes`, `No`, `Missing Invoice Number`, `Yes`, `Yes`, ( not( result( _, invoice, invoice_number, _ ) ) ) ).
header_level_scenario( `30`, `Missing Sender Name`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Sender Name`, `No`, `No`, `Missing Sender Name`, `Yes`, `Yes`, ( not( result( _, invoice, sender_name, _ ) ) ) ).
header_level_scenario( `32`, `Missing Total Gross Amount`, `Yes`, `No`, `Return to Sender`, ``, `The document is missing the following piece of data: Total Gross Amount`, `No`, `No`, `Missing Total Gross Amount`, `Yes`, `Yes`, ( not( result( _, invoice, total_invoice, _ ) ) ) ).
header_level_scenario( `35`, `Missing Total Tax Amount`, `Yes`, `No`, `Return to Sender`, ``, `The document is missing the following piece of data: Total Tax Amount`, `No`, `No`, `Missing Total Tax Amount`, `No`, `No`, ( not( result( _, invoice, total_vat, _ ) ) ) ).
header_level_scenario( `40`, `New Layout`, `No`, `No`, `Return to Sender`, ``, `The document has a new layout to any which have previously been sent by the organisation that the document relates to. A new mapping will need to be completed if the document is to be processed.`, `Yes`, `No`, `New Layout`, `No`, `No`, ( grammar_set( i_analyse_new_layout ) ) ).
header_level_scenario( `41`, `No Lines`, `Yes`, `No`, `Return to Sender`, ``, `The document does not contain any lines.`, `No`, `No`, `No Lines`, `No`, `No`, ( i_error_missing_lines ) ).
header_level_scenario( `42`, `Not On Project`, `No`, `No`, `Return to Sender`, ``, `The organisation that the document relates to has not been added to the system by the customer. This means that the document cannot be processed.`, `Yes`, `No`, `Not On Project`, `No`, `No`, ( grammar_set( i_analyse_not_on_project ) ) ).
header_level_scenario( `43`, `Old Date`, `No`, `No`, `Process As Normal`, ``, `The document date is older than the allowance.`, `No`, `No`, `Old Date`, `No`, `No`, ( grammar_set( over_x_days_old, invoice_date ) ) ).
header_level_scenario( `45`, `Positive & Negative Lines`, `Yes`, `No`, `Return to Sender`, ``, `The document contains both positive and negative lines.`, `No`, `No`, `Positive and Negative Lines`, `No`, `No`, ( i_error_positive_and_negative_lines ) ).
header_level_scenario( `48`, `Statement/Correspondence`, `No`, `No`, `Return to Sender`, ``, `The document is a statement or some other document which requires manual processing.`, `Yes`, `No`, `Statement/Correspondence`, `No`, `No`, ( grammar_set( i_analyse_statement_correspondence ) ) ).
header_level_scenario( `49`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `Yes`, `No`, `Return to Sender`, ``, `The sum of the line gross amounts are not equal to the total gross amount. Sum of Line Gross Amounts = <data>Sum of Line Gross Amounts</data>, Total Gross Amount = <data>Total Gross Amount</data>, Difference = <data>Gross Difference</data>.`, `Yes`, `No`, `Sum of Line Gross Amounts Not Equal to Total Gross Amount`, `Yes`, `Yes`, ( i_error_sum_total_discrepancy( `0.05` ), not(chained_to( `generic_taulia` )), not(chained_to( `nexans hydro` )), not( grammar_set( no_total_validation ) ) ) ).
header_level_scenario( `51`, `Totals Do Not Add Up`, `Yes`, `No`, `Return to Sender`, ``, `The document contains inconsistent totals, i.e. Total Net + Total VAT \= Total Gross.`, `Yes`, `No`, `Totals Do Not Add Up`, `Yes`, `Yes`, ( i_error_invoice_totals_inconsistent( `0.01` ) ) ).
header_level_scenario( `52`, `Unrecognised/Failed to Map Any Data`, `Yes`, `No`, `Return to Sender`, ``, `The document is either unrecognised or has failed to map any data. This is usually because it is a document that does not require processing, such as a statement or a body of an email, but can also be because the layout of the document is different to previous documents from the sender.`, `Yes`, `No`, `Unrecognised`, `No`, `No`, ( missed_data_items_condition ) ).
header_level_scenario( `53`, `Unsupported File Extension`, `No`, `No`, `Return to Sender`, ``, `The document has a file extension which is unsupported by the system. The ideal format is a data PDF (which is not the same as an image PDF), but any text-based document format will do. If text can be copied and pasted from the document, then it is in a format which is supported by the system.`, `Yes`, `No`, `Unsupported File Type`, `No`, `No`, ( i_error_unsupported_file_type ) ).
header_level_scenario( `56`, `Zero Value Document`, `No`, `No`, `Return to Sender`, ``, `The document has a total value of zero.`, `No`, `No`, `Zero Value Document`, `No`, `No`, ( i_error_zero_value_invoice ) ).


% Not Inherited
header_level_scenario( `6`, `Image Document`, `No`, `No`, `Return to Sender`, ``, `The document does not contain any text which can be read by the system, which suggests that it is an image or has been scanned. The ideal format is a data PDF (which is not the same as an image PDF), but any text-based document format will do. If text can be copied and pasted from the document, then it is in a format which is supported by the system.`, `No`, `No`, `Image Document`, `Yes`, `Yes`, ( i_error_empty ) ).
header_level_scenario( `9`, `Invalid PO line Number format`, `Yes`, `Yes`, `Action From Intervention`, ``, `The document contains invalid PO line number format`, `No`, `No`, `Invalid PO line Number format`, `Yes`, `Yes`, ( grammar_set( invalid_line_buyers_order_number) ) ).
header_level_scenario( `10`, `Missing Buyer Tax Type`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Buyer Tax Type`, `No`, `No`, `Missing Buyer Tax Type`, `No`, `No`, ( not( result( _, invoice, buyer_tax_type, _ ) ), grammar_set( amat_company_code_0003 ) ) ).
header_level_scenario( `11`, `Missing Buyer Tax Value`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Buyer Tax Value`, `No`, `No`, `Missing Buyer Tax Value`, `No`, `No`, ( not( result( _, invoice, buyer_vat_number, _ ) ), grammar_set( amat_company_code_0003 ) ) ).
header_level_scenario( `13`, `Missing Custom Field Document Type`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Custom Field Document Type`, `No`, `No`, `Missing Custom Field Document Type`, `No`, `No`, ( not( result( _, invoice, custom_document_type, _ ) ), grammar_set( amat_india_supplier ) ) ).
header_level_scenario( `14`, `Missing Custom Field Reverse Charge`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Custom Field Reverse Charge`, `No`, `No`, `Missing Custom Field Reverse Charge`, `No`, `No`, ( not( result( _, invoice, reverse_charge, _ ) ), grammar_set( amat_india_supplier ) ) ).
header_level_scenario( `15`, `Missing Custom Field Type of Supply`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Custom Field Type of Supply`, `No`, `No`, `Missing Custom Field Type of Supply`, `No`, `No`, ( not( result( _, invoice, type_of_supply, _ ) ), grammar_set( amat_india_supplier ) ) ).
header_level_scenario( `18`, `Missing Customer Reference Number`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Customer Reference Number`, `No`, `No`, `Missing Customer Reference Number`, `No`, `No`, ( not( result( _, invoice, suppliers_code_for_buyer, _ ) ), grammar_set( non_po ) ) ).
header_level_scenario( `20`, `Missing Gross Amount 1`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Gross Amount 1`, `No`, `No`, `Missing Gross Amount 1`, `No`, `No`, ( not( result( _, invoice, rate_1_gross, _ ) ), grammar_set( amat_tcs_india_tax ) ) ).
header_level_scenario( `24`, `Missing Net Amount 1`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Net Amount 1`, `No`, `No`, `Missing Net Amount 1`, `No`, `No`, ( not( result( _, invoice, rate_1_net, _ ) ), grammar_set( amat_tcs_india_tax ) ) ).
header_level_scenario( `25`, `Missing Original Invoice Number`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Original Invoice Number`, `No`, `No`, `Missing Original Invoice Number`, `No`, `No`, ( not( result( _, invoice, original_invoice_number, _ ) ), grammar_set( credit_note ) ) ).
header_level_scenario( `27`, `Missing Purchase Order Reference Number`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Purchase Order Reference Number`, `No`, `No`, `Missing Purchase Order Reference Number`, `No`, `No`, ( not( result( _, invoice, order_number, _ ) ), not( grammar_set( non_po ) ) ) ).
header_level_scenario( `31`, `Missing Tax Rate 1`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Tax Rate 1`, `No`, `No`, `Missing Tax Rate 1`, `No`, `No`, ( not( result( _, invoice, vat_rate_1, _ ) ), grammar_set( amat_tcs_india_tax ) ) ).
header_level_scenario( `33`, `Missing Total Header Taxes`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Total Header Taxes`, `No`, `No`, `Missing Total Header Taxes`, `No`, `No`, ( not( result( _, invoice, total_header_taxes, _ ) ), grammar_set( amat_tcs_india_tax ) ) ).
header_level_scenario( `34`, `Missing Total Net Amount`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Total Net Amount`, `No`, `No`, `Missing Total Net Amount`, `No`, `No`, ( not( result( _, invoice, total_net, _ ) ), grammar_set( amat_tcs_india_tax ) ) ).
header_level_scenario( `37`, `Missing Vendor Reference Number`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Vendor Reference Number`, `No`, `No`, `Missing Vendor Reference Number`, `No`, `No`, ( not( result( _, invoice, buyers_code_for_supplier, _ ) ), grammar_set( non_po ) ) ).
header_level_scenario( `44`, `PDF Error`, `No`, `No`, `Return to Sender`, ``, `The document is a PDF which is either secured or contains an embedded font, which means that the system cannot read the text contained within the document. In order for the document to be processed, it must be generated by either using a different method or by changing the settings on the application which generates the document. The ideal format is a data PDF (which is not the same as an image PDF), but any text-based document format will do. If text can be copied and pasted from the document, then it is in a format which is supported by the system.`, `No`, `No`, `PDF Error`, `Yes`, `Yes`, ( i_error_pdf_error ) ).
header_level_scenario( `50`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `Yes`, `No`, `Return to Sender`, ``, `The sum of the line net amounts are not equal to the total net amount. Sum of Line Net Amounts = <data>Sum of Line Net Amounts</data>, Total Net Amount = <data>Total Net Amount</data>, Difference = <data>Net Difference</data>.`, `Yes`, `No`, `Sum of Line Net Amounts Not Equal to Total Net Amount`, `Yes`, `Yes`, ( i_error_sum_net_discrepancy( `0.05` ), not(chained_to( `generic_taulia` )), not(chained_to( `nexans hydro` )), not( grammar_set( no_total_validation ) ) ) ).
...
% Not Inherited
line_level_scenario( `16`, `Missing Custom Line Field HSN Code`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Custom Line Field HSN Code`, `No`, `No`, `Missing Custom Line Field HSN Code`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `16_Missing Custom Line Field HSN Code`, LID), not( result( _, LID, line_hsn_code, _ ) ), grammar_set( amat_india_supplier ) ) ).
line_level_scenario( `17`, `Missing Custom Line Field Is Service`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Custom Line Field Is Service`, `No`, `No`, `Missing Custom Line Field Is Service`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `17_Missing Custom Line Field Is Service`, LID), not( result( _, LID, line_is_service, _ ) ), grammar_set( amat_india_supplier ) ) ).
line_level_scenario( `23`, `Missing Line VAT Type`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Line VAT Type`, `No`, `No`, `Missing Line VAT Type`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `23_Missing Line VAT Type`, LID), not( result( _, LID, line_vat_type, _ ) ), grammar_set( amat_india_supplier ); grammar_set( amat_taiwan_supplier ) ) ).
line_level_scenario( `26`, `Missing PO Item Number`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: PO Item Number`, `No`, `No`, `Missing PO Item Number`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `26_Missing PO Item Number`, LID), not( result( _, LID, line_buyers_order_number, _ ) ), result( _, invoice, order_number, _ ), not( result( _, LID, line_type, `extra` ) ), not( result( _, LID, line_type, `gross_subtotal_3` ) ) ) ).
line_level_scenario( `29`, `Missing Quantity Unit of Measure`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Quantity Unit of Measure`, `No`, `No`, `Missing Quantity Unit of Measure`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `29_Missing Quantity Unit of Measure`, LID), not( result( _, LID, line_quantity_uom_code, _ ) ) ) ).
line_level_scenario( `46`, `Quantity Times Unit Amount Not Equal to Net Amount`, `No`, `No`, `Process As Normal`, ``, `The quantity times the unit price is not equal to the net price for lines <data>Quantity Times Unit Amount Not Equal to Net Amount Occurred At Lines</data>.`, `No`, `No`, `Quantity Times Unit Amount Not Equal to Net Amount`, `Yes`, `Yes`, ( grammar_set(`testing_document_scenario`, `46_Quantity Times Unit Amount Not Equal to Net Amount`, LID), not( grammar_set(qty_no_error) ), i_error_quantity_and_unit_and_net_amounts_inconsistent( LID, `0.05` ) ) ).
line_level_scenario( `47`, `Quantity Times Unit Amount Not Equal to Net Amount (Qty No Error)`, `No`, `No`, `Process As Normal`, ``, `The quantity times the unit price is not equal to the net price for lines <data>Quantity Times Unit Amount Not Equal to Net Amount (Qty No Error) Not Equal to Net Amount Occurred At Lines</data>.`, `No`, `No`, `Quantity Times Unit Amount Not Equal to Net Amount`, `Yes`, `Yes`, ( grammar_set(`testing_document_scenario`, `47_Quantity Times Unit Amount Not Equal to Net Amount (Qty No Error)`, LID), grammar_set(qty_no_error), i_error_quantity_and_unit_and_net_amounts_inconsistent( LID, `1` ) ) ).
line_level_scenario( `57`, `Zero Value Line`, `No`, `No`, `Suppress Output of Zero Value Lines`, ``, `The following lines are zero value: <data>Zero Value Line At Lines</data>.`, `No`, `No`, `Zero Value Line`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `57_Zero Value Line`, LID), i_error_zero_value_line( LID ) ) ).


% Document scenario inherited from Taulia
line_level_scenario( `19`, `Missing Description`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Description`, `No`, `No`, `Missing Description`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `19_Missing Description`, LID), not( result( _, LID, line_descr, _ ) ) ) ).
line_level_scenario( `28`, `Missing Quantity`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Quantity`, `No`, `No`, `Missing Quantity`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `28_Missing Quantity`, LID), not( result( _, LID, line_quantity, _ ) ) ) ).
line_level_scenario( `36`, `Missing Unit Price`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: Unit Price`, `No`, `No`, `Missing Unit Price`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `36_Missing Unit Price`, LID), not( result( _, LID, line_unit_amount, _ ) ) ) ).
line_level_scenario( `38`, `Negative Quantity`, `Yes`, `No`, `Return to Sender`, ``, `Please note that the invoice contains negative quantity.`, `No`, `No`, `Negative Quantity`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `38_Negative Quantity`, LID), grammar_set( negative_qty, LID ) ) ).
line_level_scenario( `39`, `Negative Unit Price`, `Yes`, `No`, `Return to Sender`, ``, `Please note that the invoice contains negative unit price.`, `No`, `No`, `Negative Unit Price`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `39_Negative Unit Price`, LID), grammar_set( negative_unit_price, LID ) ) ).
line_level_scenario( `54`, `Zero Quantity`, `Yes`, `No`, `Return to Sender`, ``, `Please note that the invoice contains zero quantity.`, `No`, `No`, `Zero Quantity`, `Yes`, `Yes`, ( grammar_set(`testing_document_scenario`, `54_Zero Quantity`, LID), grammar_set( zero_qty, LID ) ) ).
line_level_scenario( `55`, `Zero Unit Price`, `Yes`, `No`, `Return to Sender`, ``, `Please note that the invoice contains zero unit price.`, `No`, `No`, `Zero Unit Price`, `Yes`, `Yes`, ( grammar_set(`testing_document_scenario`, `55_Zero Unit Price`, LID), grammar_set( zero_unit_price , LID ) ) ).
