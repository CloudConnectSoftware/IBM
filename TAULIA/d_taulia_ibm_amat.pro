...
i_version( d_taulia_ibm_amat, `23/07/2026 06:27:42` ).
...
line_level_scenario( `26`, `Missing PO Item Number`, `Yes`, `No`, `Action From Intervention`, ``, `The document is missing the following piece of data: PO Item Number`, `No`, `No`, `Missing PO Item Number`, `No`, `No`, ( grammar_set(`testing_document_scenario`, `26_Missing PO Item Number`, LID), not( result( _, LID, line_buyers_order_number, _ ) ) ) ).
