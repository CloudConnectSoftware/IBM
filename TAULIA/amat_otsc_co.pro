...
i_version(amat_otsc_co, `05 April, 2021` ).
...
%=======================================================================
     ...
     sender_name( `OTSC Co,. Ltd` )

   % Supplier VAT number - 109-81-85343 %

   , currency(`KRW`)

   , supplier_registration_number(`HWAN9511@OTSC.CO.KR`)
