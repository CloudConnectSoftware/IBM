...
i_version( intuit_taulia_cognizant, `27 Nov, 2020` ).
...
, generic_horizontal_details( [ [`Amount`,  `before`,  `tax`,  tab ], total_net, d, newline ] )
...
, generic_horizontal_details( [ [  `VAT`, `:`,  tab, generic_item( [ default_vat_rate, d ] ), `.`, `0000`,  `%`,  tab  ], total_vat, d, newline ] )
...
,  generic_horizontal_details( [ [ `Amount`,  `after`,  `tax`,  tab, dummy_num(d),  tab ],  currency, w, newline ] )
