...
i_version( intuit_taulia_cpawebengage, `29 January, 2018` ).
...
%=======================================================================
     ...
     generic_item( [supplier_city , s , [q10(tab), check(supplier_city(end) < 45)] ] )
...
,[generic_vertical_details( [ [`BALANCE`, `DUE`], `BALANCE`, q(0,1), (start,200,400), total_invoice, d , newline ] )
...
%=======================================================================
    ...
    , qn0( [ peek_fails(line_end_line)
        ...
        [q10(line_descr_line),q10(line_append_line),q10(line_append_line),line_invoice_line,q10(line_append_line),q10(line_append_line),q10(line_append_line)]
