%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SHANGHAI M&G COLIPU OFFICE SUPPLIES CO., / V # 9000182001 / Compcode: 0059, 0069, 0065 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

i_version(amat_shanghai_mgcolipu_offsupp,  `2025-07-25 17:59:05` ).
...
%=======================================================================
     ...
     sender_name( `SHANGHAI M&G COLIPU OFFICE SUPPLIES CO.,` )

   % Supplier VAT number - 9131010405769500XK % 

   , supplier_registration_number(`huanghua@colipu.com`)
...
%=======================================================================
   ...
   , line_add_line_date_11

   
 ] ).

%=======================================================================
i_line_rule_cut( line_add_line_date_11, [
%=======================================================================
...
, or( [
          ...
          , [ generic_item( [ order_number , [ begin, q(alpha("P"),1,1) , q(alpha("O"),1,1) ,q(dec("4"),1,1) , q(dec("5"),1,1), q(dec,8,10) , end ] ] ), set(order_number_44) ]
    ] )
...
%=======================================================================
    ...
    , or( [                           
          ...
          [generic_horizontal_details( [ [ `价税合计`, `（`, `大写`, `）`,  tab, `叁佰肆拾肆圆肆角伍分`,  tab, `（`, `小写`, `）`,  `¥` ], total_invoice, d, newline ] )
