...
%=======================================================================
     ...
     sender_name( `MORGAN KOREA CO LTD` )

   % Supplier VAT number - 777-85-00112 %

   , currency(`KRW`)

   , supplier_registration_number(`lisahyunjoo.yeo@morganplc.com`)
