...
i_version( intuit_taulia_roaming_hunger, `7 Feb, 2018` ).
...
%=======================================================================
    ...
    sender_name( `Roaming Hunger, Inc` )
...
%=======================================================================
       ...
       read_ahead([`From`, tab, `Roaming`, `Hunger`])

     , trace( [ `Found address`] )

     , generic_item( [ supplier_partyDummy, s1, tab ] )
...
%=======================================================================
     ...
     , generic_item( [supplier_dummy , s , [q10(tab), check(supplier_dummy(end) < 319)] ] )
...
%=======================================================================
     ...
     q(0,10,line)
       ...
       ,  generic_horizontal_details( [ [ `Invoice`, `ID`, tab ], invoice_number, d, tab ] )
...
%=======================================================================
   ...
   ,  generic_horizontal_details( [ [`Due`, `Date`, tab ], due_date, date, `(` ] )
...
%=======================================================================
      ...
      generic_item( [ line_descr_dummy, s1, [tab, q10(`$`)] ] )
