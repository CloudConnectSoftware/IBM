...
:-
    ...
    sys_findall( TOT1,   
        result( _, _, line_net_amount, TOT1 ),   
        TOT1s  ),  
     
    i_user_check( sum_string_list, TOT1s, Sum1 ),  
    
    assertz_derived_data( invoice, total_net, Sum1, i_sum_all_line_tot1s),  
    !
    .
